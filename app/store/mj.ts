import { ACCESS_CODE_PREFIX, ApiPath, MJProxy, StoreKey } from "@/app/constant";
  ...
  (set, _get) => {
    ...
    const methods = {
      ...
      async MjRequestCall(
        ...
        let prefix: string = ApiPath.Midjourney as string;
        let bearerToken = "";
        if (
          ...
          prefix =
            accessStore.midjourneyProxyUrl || (ApiPath.Midjourney as string);
          bearerToken = getBearerToken(accessStore.midjourneyProxySecret);
        }
